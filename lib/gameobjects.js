...
function Ship(initial) {
  ...
  this.on_after_init();
  this.weapon         = new RapidFireUpgrade(new CannonWeapon(this));
}
...
CannonWeapon.prototype.get_energy_cost = function() {
...
var SpreadShotUpgrade = function(weapon) {
	this.weapon = weapon;
};
...
var RicoUpgrade = function(weapon) {
  this.weapon = weapon;
  this.lifetime = 1.33;
};
